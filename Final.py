...
player1=pygame.image.load("resources/resized_basket.png")
player2=pygame.image.load("resources/resized_egg.png")
player=player1
...
def gameloop():
    global eggx,eggy,r,pause,speed,speed1,high,score_file,player,beg,c,d,mode
    screen.fill(0)  
    flagy=1
    beg=True
    count=0
